...
{
    public partial class Identityinit1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CovidDatas", x => x.CovidDataId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CitizenHospitals", x => x.CitizenId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PatientId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CitizenUsername = table.Column<int>(nullable: false),
                    HospitalId = table.Column<int>(nullable: false),
                    applicationUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfDue = table.Column<DateTime>(nullable: false),
                    Finished = table.Column<bool>(nullable: false),
                    DateOfFinished = table.Column<DateTime>(nullable: false),
                    HospitalId = table.Column<int>(nullable: false),
                    applicationUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
